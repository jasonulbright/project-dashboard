...
/// <summary>
/// The reflog viewer. It holds no state of its own — the entries, the ref picker, and the
/// branch-creation gate live on <see cref="ViewModels.Pages.ProjectDetailViewModel"/> — so the
/// surface cannot drift from the rules the view model enforces.
/// </summary>
public partial class ReflogView
{
    public ReflogView() => InitializeComponent();
