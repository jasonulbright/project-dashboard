...
public class RewriteScrubVerdictTests
{
    ...
    [InlineData("preflight: these tags cannot round-trip through fast-export — refs/tags/outer is a nested tag: it points at another tag object", "cannot round-trip")]
    [InlineData("preflight: these tags cannot round-trip through fast-export — refs/tags/beta holds a tag object named 'alpha', which the export would re-emit as 'beta'", "does not match the ref holding it")]
